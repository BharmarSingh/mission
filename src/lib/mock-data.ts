...
export const initialMissions: Mission[] = [
  {
    ...
    status: "active",
    priority: "high",
    assignedTo: ["Sarah Chen", "Marcus Webb", "Alex Rodriguez"],
...
export const availableAgents = [
  { id: "1", name: "Sarah Chen", department: "Security", role: "Senior Agent" },
  { id: "2", name: "Marcus Webb", department: "Intelligence", role: "Analyst" },
  {
    id: "3",
